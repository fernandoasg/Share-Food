...
//                    if(e == null){
//                        int entityId = entity.getObjectId();
//                        System.out.println("inside = "+entityId);
//
//                        if(entityId != null) {
//                            SessionManager sessionManager = new SessionManager(context);
//                            sessionManager.createRegisterSession(entityId, entity.get("email").toString(), entity.get("nome").toString(), entity.get("tipo").toString());
//                        }
//                    }else{
//                        ParseUser.logOut();
